...
namespace _07Petzold.ListWithListBoxItems
{
    class ListWithListBoxItems : Window
    {
        ...
        {
            Title = "List With ListBox Item";
            // Creation of ListBox object as window content
            ...
            // Filling list by ListBoxItems elements
